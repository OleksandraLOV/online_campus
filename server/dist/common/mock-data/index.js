...
exports.notifications = exports.grades = exports.submissions = exports.assignments = exports.materials = exports.scheduleEntries = exports.classrooms = exports.courseAssignments = exports.courses = exports.groups = exports.teacherProfiles = exports.studentProfiles = exports.users = exports.departments = exports.faculties = void 0;
...
exports.users = [
    { id: 'user-s1', login: 'student1', passwordHash: hash, role: roles_enum_1.Role.STUDENT, email: 'student1@maup.com.ua', phone: '+380991111111', firstName: 'Олександр', lastName: 'Петренко', middleName: 'Іванович', status: 'active', createdAt: '2024-09-01' },
    { id: 'user-s2', login: 'student2', passwordHash: hash, role: roles_enum_1.Role.STUDENT, email: 'student2@maup.com.ua', phone: '+380992222222', firstName: 'Марія', lastName: 'Коваленко', middleName: 'Сергіївна', status: 'active', createdAt: '2024-09-01' },
    { id: 'user-s3', login: 'student3', passwordHash: hash, role: roles_enum_1.Role.STUDENT, email: 'student3@maup.com.ua', firstName: 'Андрій', lastName: 'Шевченко', status: 'active', createdAt: '2024-09-01' },
    { id: 'user-s4', login: 'student4', passwordHash: hash, role: roles_enum_1.Role.STUDENT, email: 'student4@maup.com.ua', firstName: 'Ірина', lastName: 'Бондаренко', status: 'active', createdAt: '2024-09-01' },
    { id: 'user-t1', login: 'teacher1', passwordHash: hash, role: roles_enum_1.Role.TEACHER, email: 'teacher1@maup.com.ua', firstName: 'Віктор', lastName: 'Мельник', middleName: 'Олегович', status: 'active', createdAt: '2024-08-01' },
    { id: 'user-t2', login: 'teacher2', passwordHash: hash, role: roles_enum_1.Role.TEACHER, email: 'teacher2@maup.com.ua', firstName: 'Наталія', lastName: 'Кравченко', middleName: 'Петрівна', status: 'active', createdAt: '2024-08-01' },
    { id: 'user-t3', login: 'teacher3', passwordHash: hash, role: roles_enum_1.Role.TEACHER, email: 'teacher3@maup.com.ua', firstName: 'Сергій', lastName: 'Ткаченко', status: 'active', createdAt: '2024-08-01' },
    { id: 'user-d1', login: 'dispatcher1', passwordHash: hash, role: roles_enum_1.Role.DISPATCHER, email: 'dispatcher@maup.com.ua', firstName: 'Олена', lastName: 'Савченко', status: 'active', createdAt: '2024-08-01' },
    { id: 'user-head-1', login: 'head1', passwordHash: hash, role: roles_enum_1.Role.DEPARTMENT_HEAD, email: 'head1@maup.com.ua', firstName: 'Петро', lastName: 'Григоренко', middleName: 'Васильович', status: 'active', createdAt: '2024-01-01' },
    { id: 'user-head-2', login: 'head2', passwordHash: hash, role: roles_enum_1.Role.DEPARTMENT_HEAD, email: 'head2@maup.com.ua', firstName: 'Ганна', lastName: 'Литвиненко', status: 'active', createdAt: '2024-01-01' },
    { id: 'user-dean-1', login: 'dean1', passwordHash: hash, role: roles_enum_1.Role.DEAN, email: 'dean1@maup.com.ua', firstName: 'Михайло', lastName: 'Козлов', middleName: 'Андрійович', status: 'active', createdAt: '2024-01-01' },
    { id: 'user-dean-2', login: 'dean2', passwordHash: hash, role: roles_enum_1.Role.DEAN, email: 'dean2@maup.com.ua', firstName: 'Тетяна', lastName: 'Іванова', status: 'active', createdAt: '2024-01-01' },
    { id: 'user-rector', login: 'rector', passwordHash: hash, role: roles_enum_1.Role.RECTOR, email: 'rector@maup.com.ua', firstName: 'Володимир', lastName: 'Сидоренко', middleName: 'Миколайович', status: 'active', createdAt: '2023-01-01' },
    { id: 'user-president', login: 'president', passwordHash: hash, role: roles_enum_1.Role.PRESIDENT, email: 'president@maup.com.ua', firstName: 'Юрій', lastName: 'Головко', middleName: 'Борисович', status: 'active', createdAt: '2023-01-01' },
    { id: 'user-admin', login: 'admin', passwordHash: hash, role: roles_enum_1.Role.ADMIN, email: 'admin@maup.com.ua', firstName: 'Адмін', lastName: 'Системний', status: 'active', createdAt: '2023-01-01' },
];
exports.studentProfiles = [
